        ...
        <div class="main-content-wrapper">
            ...
            <main>
                ...
                <div class="relatorio" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="background-color: #f8d7da; color: #721c24; padding: 15px; border-radius: 6px; border: 1px solid #f5c6cb; margin-bottom: 25px; font-size: 0.9rem;">
                        ⚠️ <strong>Atenção crítica:</strong> esta ação apagará todo o arquivo passivo atual e substituirá os dados pelos registros do novo CSV. Faça um backup antes.
                    </div>
