            ...
            <main>
                ...
                <div class="relatorio" style="max-width: 800px; margin: 0 auto;">
                    ...
                    <form method="POST" class="sistema">
                        ...
                        <h3
                            style="border-bottom: 1px solid #eee; padding-bottom: 10px; margin-bottom: 20px; margin-top: 20px; color: var(--danger-color);">
                            Segurança
                        </h3>

                        <div
                            style="background-color: #fff5f5; padding: 20px; border-radius: 8px; border: 1px solid #ffc9c9; margin-bottom: 20px;">
                        ...
                        <div
                            style="background-color: #e8f4ff; padding: 20px; border-radius: 8px; border: 1px solid #b8daff; margin-top: 30px;">
                            ...
                            <input type="password" name="senha_atual" required
                                placeholder="Sua senha usada para logar agora" style="margin-bottom: 0;">
                        </div>
