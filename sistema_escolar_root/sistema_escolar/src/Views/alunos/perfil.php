                ...
                <div class="card-perfil">
                    <?php if ($status == 'vencida'): ?>
                        <div class="status-box st-vencida">
                            <h2>DVA VENCIDA</h2>
                            <p>Venceu ha <strong><?php echo abs($dias); ?> dias</strong> (<?php echo date('d/m/Y', strtotime($aluno['data_dva'])); ?>)</p>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="status-box st-sem_dva">
                            ...
                            <p>Este aluno nao possui data de vencimento cadastrada.</p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="perfil-info-grid">
                        ...
                        <div class="info-item">
                            <div class="info-label">Observacoes DVA</div>
                        ...
                        <div class="contatos-grid">
                            <div class="contato-card">
                                ...
                                <div class="contato-numero">
                                    <?php echo !empty($aluno['telefone_aluno']) ? e($aluno['telefone_aluno']) : '<span style="color:#999; font-weight:normal;">Nao informado</span>'; ?>
                                </div>
                            ...
                            <div class="contato-card">
                                <div class="contato-label">Responsavel</div>
                                <div class="contato-numero">
                                    <?php echo !empty($aluno['telefone_responsavel']) ? e($aluno['telefone_responsavel']) : '<span style="color:#999; font-weight:normal;">Nao informado</span>'; ?>
                                </div>
                                <?php if (!empty($aluno['telefone_responsavel'])): ?>
                                    <?php $numResp = preg_replace('/[^0-9]/', '', $aluno['telefone_responsavel']); ?>
                                    <a href="https://wa.me/55<?php echo e($numResp); ?>" target="_blank" class="btn-whatsapp-full" rel="noopener noreferrer">Chamar Responsavel</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="perfil-actions" style="margin-top: 30px;">
                        <a href="/aluno/editar/<?php echo (int)$aluno['id']; ?>" class="btn-primary" style="text-decoration:none;">Editar Dados / Renovar DVA</a>
                        ...
                        <?php if ($_SESSION['usuario_tipo'] === 'admin'): ?>
                            <form action="/aluno/excluir/<?php echo (int)$aluno['id']; ?>" method="POST" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja apagar este aluno permanentemente?');">
                                ...
                                <button type="submit" class="btn-secondary" style="background:var(--danger-color); text-decoration:none; border:0; cursor:pointer;">Apagar Aluno</button>
                            </form>
                        <?php endif; ?>
